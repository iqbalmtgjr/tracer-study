                    ...
                    <div class="card-body p-4">
                        <form wire:submit.prevent="submitForm">
                            ...
                            <div class="mb-5 pb-4 border-bottom">
                                ...
                                <div class="ms-3">
                                    ...
                                    <div class="ms-4 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            class="form-control" placeholder="Ketik jawaban lainnya..." required>
                                    ...
                                    @endif
                                    @if (
                                    in_array($question->question_code, ['f1201','f1201_belum_bekerja','f1201_wiraswasta','f1201_mencari_kerja']) &&
                                    ...
                                    <div class="ms-4 mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            class="form-control" placeholder="Ketik jawaban ..." required>
                                ...
                                @if ($question->question_code === 'f505_bekerja_wiraswasta')
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        placeholder="0"
                                        x-data="{ 
                    value: @entangle('answers.' . $question->question_code),
                    formatRupiah(angka) {
                        ...
                        return rupiah;
                                        ...
                                        x-init="if(value) $el.value = formatRupiah(value.toString())"
                                        required>
                                </div>
                                @else
                                {{-- Input number biasa --}}
                                ...
                                <input type="date" wire:model="answers.{{ $question->question_code }}"
                                    class="form-control form-control-lg" placeholder="dd/mm/yy"
                                    required>
                                @endif
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @for ($i = 1; $i <= 5; $i++)
                                                    ...
                                                    <input type="radio"
                                                        {{-- BINDING LIVEWIRE DENGAN KODE: QCode.RowCode_Column --}}
                                            ...
                                            <tr>
                                                <td colspan="11" class="text-danger small">{{ $message }} (Kolom A)</td>
                                            </tr>
                                            @enderror
                                            @error("gridAnswers.{$question->question_code}.{$gridRow->row_code}_B")
                                            <tr>
                                                <td colspan="11" class="text-danger small">{{ $message }} (Kolom B)</td>
                                            </tr>
                                            @enderror
                                            @endforeach
                                        </tbody>

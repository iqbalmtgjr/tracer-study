                                ...
                                @if ($this->shouldShow($question))
                                    ...
                                    <div class="mb-5 pb-4 border-bottom">
                                        ...
                                        @if ($question->input_type === 'select2' && $question->question_code === 'f5a2')
                                            ...
                                            // Re-init when kabupaten data changes
                                            $watch('$wire.kabupaten', value => {
                                                setTimeout(() => {
                                                    initKabupaten();
                                                }, 100);
                                            });
                                            ...
                                            @if (empty($kabupaten) || count($kabupaten) == 0)
                                                <small class="text-muted mt-2 d-block">
                                                    <i class="fas fa-info-circle me-1"></i>Silakan pilih provinsi
                                                    terlebih dahulu
                                                </small>
                                            @endif
                                        ...
                                        {{-- 9. Select2 Kabupaten (SOLUSI TERBAIK) --}}
                                        @if ($question->input_type === 'select2' && $question->question_code === 'f5a2')
                                            <div>
                                                {{-- Wrapper dengan wire:ignore untuk protect Select2 --}}
                                                {{-- <div wire:ignore>
                                                    <select class="form-select form-select-lg" id="kabupaten-select">
                                                        <option value="">-- Pilih Kabupaten --</option>
                                                    </select>
                                                ...
                                                {{-- Hidden input untuk menyimpan data kabupaten dari Livewire --}}
                                                <input type="hidden" id="kabupaten-data"
                                            ...
                                            @script
                                                <script>
                                                    ...
                                                    let kabupatenSelect = $('#kabupaten-select');
                                                    let questionCode = '{{ $question->question_code }}';
                                                    ...
                                                    // Sync with Livewire
                                                    kabupatenSelect.on('change', function(e) {
                                                        $wire.set('answers.' + questionCode, $(this).val());
                                                    });

                                                    // Watch for kabupaten data changes
                                                    const updateKabupatenOptions = () => {
                                                        let kabupatenData = JSON.parse($('#kabupaten-data').val() || '[]');
                                                        ...
                                                        kabupatenData.forEach(item => {
                                                            let option = new Option(item.nama_kabupaten_kota_kota, item.kode_kabupaten, false, false);
                                                    ...
                                                    // Watch for changes in hidden input
                                                    const observer = new MutationObserver(updateKabupatenOptions);
                                                    observer.observe(document.getElementById('kabupaten-data'), {
                                                        attributes: true,
        ...
        <script>
            ...
            function initializeSelect2() {
                if (typeof jQuery !== 'undefined' && typeof jQuery.fn.select2 !== 'undefined') {
                    let $select = jQuery('#provinsi-select');
